...
const createLocalStorageCitiesService = (storage: Storage) => {
  return new LocalStorageCitiesService(storage);
};
...
@NgModule({
  ...
  providers: [
    ...
    {
      provide: LocalStorageCitiesService,
      useFactory: createLocalStorageCitiesService,
      deps: [Storage],
    }
  ],
